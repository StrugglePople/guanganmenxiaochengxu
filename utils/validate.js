...
module.exports = {
  ...
  isMobile: isMobile,
  isEmail: isEmail,
  varisRealName: varisRealName,
  isNumEn: isNumEn,
  isName: isName,
  isChinaId: isChinaId,
  isidentifyNumber:isidentifyNumber
}